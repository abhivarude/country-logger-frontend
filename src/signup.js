...
<div className="col">
  ...
  <img src="https://res.cloudinary.com/abhiscompany/image/upload/v1634107443/signup_uzmllm.png" width="490px" height="400px"></img>
</div>
...
const data= await axios.post("https://country-logger.herokuapp.com/signup",{name:values.name,email:values.email,password:values.password})
